...
# Setup client
finnhub_client = finnhub.Client(api_key="c0qniqv48v6q5go2lo6g")

#Get Dow Jones, S&P 500 Data, Nasdaq
r = requests.get('https://finnhub.io/api/v1/quote?symbol=AAPL&token=c0qniqv48v6q5go2lo6g')
print(r.json())
# dowJones = finnhub_client
# SP500 = finnhub_client
# print(dowJones)
# print(SP500)
